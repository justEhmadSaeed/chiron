import { QCResult, ExperimentPlanData } from './types';

export const EXAMPLE_QUESTIONS = [
  "What is the effect of CRISPR-Cas9 targeting APOE4 on amyloid-beta accumulation in iPSC-derived Alzheimer's neurons?",
  "How does gut microbiome composition influence CAR-T cell therapy efficacy in solid tumor models?",
  "What role does mTOR signaling play in tau phosphorylation under hypoxic conditions in neural organoids?",
  "Can PROTAC-mediated degradation of BRD4 overcome enzalutamide resistance in castration-resistant prostate cancer?",
  "How does SARS-CoV-2 spike protein binding affect ACE2 expression in lung organoids over 72 hours?",
];
...
export const MOCK_PLAN: ExperimentPlanData = {
  title: "CRISPR-Cas9 APOE4 Correction in iPSC-Derived Alzheimer's Neurons",
  question:
    "What is the effect of CRISPR-Cas9 targeting of the APOE4 gene variant on amyloid-beta accumulation in iPSC-derived neurons from Alzheimer's disease patients?",
  createdAt: '2026-04-25',
  complexity: 'Very High',
  teamSize: 4,
  totalWeeks: 15,
  hypothesis:
    'Correcting the APOE4 allele to APOE3 via HDR-based CRISPR editing will significantly reduce Aβ42 secretion (≥30%) and Aβ42/Aβ40 ratio in differentiated cortical neurons, restoring lipid homeostasis pathways associated with reduced AD pathology.',
  overview:
    'This experiment employs CRISPR-Cas9 with HDR to convert the rs429358 SNP (APOE4→APOE3) in patient-derived iPSCs, followed by directed cortical neuron differentiation and multi-modal functional analysis. Primary endpoints are Aβ42 secretion and Aβ42/Aβ40 ratio. Secondary endpoints include tau phosphorylation, lipid metabolism markers, and synaptic density. Isogenic control lines will be used throughout to isolate APOE genotype-specific effects.',
  protocol: [
    {
      ...
      steps: [
        {
          ...
          detail:
            'Thaw APOE4/4 patient iPSC line (Coriell AG09908) in pre-warmed mTeSR1 media supplemented with 10 μM ROCK inhibitor Y-27632. Plate on Matrigel-coated 6-well plates at 2.5×10⁵ cells/cm². Change media daily; remove ROCK inhibitor after 24h.',
          duration: '7 days',
          critical: true,
        ...
        },
        {
          ...
          detail:
            'Confirm pluripotency via immunofluorescence (OCT4, SOX2, NANOG, TRA-1-60). Karyotype analysis (G-banding, 20 metaphases). STR profiling to verify identity. Mycoplasma test.',
          duration: '3 days',
          critical: false,
        ...
        },
        {
          ...
          detail:
            "Design 3 sgRNAs targeting the APOE4-specific SNP (chr19:44908684, rs429358) using Benchling with Doench 2016 scoring. Rank by on-target efficiency and off-target prediction. Synthesize via Synthego CRISPRevolution. Validate by T7E1 mismatch cleavage assay in HEK293T cells transfected with Cas9 plasmid.",
          duration: '5 days',
          critical: true,
      ...
      steps: [
        {
          ...
          detail:
            'Assemble Cas9 RNP at 1:2 molar ratio (Cas9:sgRNA). Incubate at RT for 10 min. Prepare ssODN HDR template (200 nt symmetric arms, phosphorothioate-protected termini) at 4 μM. Add Alt-R HDR Enhancer (IDT) to boost HDR efficiency.',
          duration: '1 day',
          critical: true,
        },
        {
          ...
          title: 'Nucleofection',
          detail:
            'Lift iPSCs at 70–80% confluency (Accutase, 5 min). Count and resuspend 2×10⁶ cells in 100 μL P3 solution (Lonza 4D-Nucleofector). Nucleofect using program CB-150. Immediately transfer to pre-warmed mTeSR1 + ROCK inhibitor. Assess viability at 24h.',
          duration: '1 day',
          critical: true,
        ...
        },
        {
          ...
          detail:
            'At 48h post-nucleofection, dissociate cells (Accutase). Sort single cells by FACS (BD FACSAria III) into 96-well plates containing conditioned media + 10 μM Y-27632 + 10% CloneR supplement. Expand clones 10–14 days.',
          duration: '14 days',
          critical: false,
        },
        {
          ...
          detail:
            'Extract gDNA from 96 clones. PCR-amplify 350 bp around edit site. Sanger sequencing. Select 10 correctly edited clones. Perform GUIDE-seq off-target analysis on top 5 candidates. Whole-genome SNP array to confirm genome stability.',
          duration: '7 days',
          critical: true,
      ...
      steps: [
        {
          ...
          detail:
            'Day 0: Switch confirmed edited clones + isogenic controls to neural induction media (DMEM/F12 + Neurobasal 1:1, N2, B27 without Vit A, 10 μM SB431542, 100 nM LDN193189). Change media daily. Neuroepithelial rosettes should appear by day 7.',
          duration: '10 days',
          critical: false,
        },
        {
          ...
          detail:
            'Day 10–17: Add BDNF (20 ng/mL), NT-3 (10 ng/mL), DAPT (10 μM). Day 17+: Transfer to BrainPhys media (STEMCELL Tech). Add laminin (1 μg/mL), ascorbic acid (200 μM), cAMP (0.5 mM). Maintain for 6 additional weeks with 50% media change every 3 days.',
          duration: '42 days',
          critical: false,
      ...
      steps: [
        {
          ...
          detail:
            'Collect 200 μL conditioned media every 24h from day 56–70 post-differentiation. Centrifuge 1000×g to remove debris. Measure Aβ40 and Aβ42 using Invitrogen ELISA kits (KHB3481, KHB3441) following manufacturer protocol. Run n=6 technical replicates per condition × 3 biological replicates.',
          duration: '14 days',
          critical: true,
        ...
        },
        {
          ...
          detail:
            'Fix cells with 4% PFA (15 min, RT). Permeabilize with 0.1% Triton X-100. Block with 5% normal goat serum. Primary antibodies: pTau Ser396 (1:500), MAP2 (1:1000), DAPI. Secondary: Alexa Fluor 488/568. Image on confocal (Zeiss LSM 980, 40× oil objective). Quantify with CellProfiler pipeline.',
          duration: '5 days',
          critical: false,
        },
        {
          ...
          detail:
            'Lyse cells in RIPA (protease + phosphatase inhibitors). Protein quantification by BCA assay. Digest with LysC + Trypsin (1:50). Label with TMT 10-plex. Mix equally, fractionate by HPLC. LC-MS/MS on Q Exactive HF platform. Search against UniProt human proteome. Analyze in Perseus.',
          duration: '7 days',
          critical: false,
        ...
        },
        {
          ...
          detail:
            'Primary endpoint: Student\'s t-test (APOE3-edited vs APOE4 control) with Bonferroni correction. ELISA data normalized to total protein concentration. Proteomics: FDR <0.05 (Perseus permutation-based). GSEA pathway analysis (MSigDB v2024). Visualization in R (ggplot2, ComplexHeatmap).',
          duration: '5 days',
          critical: false,
        },
      ],
