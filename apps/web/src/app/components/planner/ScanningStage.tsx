import { BookOpen, CheckCircle2, Database, Loader2, Network, Search, Shield } from "lucide-react";
...
const SCAN_STEPS: ScanStep[] = [
  {
    id: 1,
    icon: Search,
    label: "Parsing research intent",
    sublabel: "Extracting entities, targets, model organisms...",
    duration: 800
  },
  {
    id: 2,
    icon: Network,
    label: "Building semantic query graph",
    sublabel: "APOE4 · iPSC · CRISPR-Cas9 · Amyloid-beta · Alzheimer's...",
    duration: 900
  },
  {
    id: 3,
    icon: Database,
    label: "Querying PubMed (35M papers)",
    sublabel: "Searching by MeSH terms + semantic similarity...",
    duration: 1100
  },
  {
    id: 4,
    icon: BookOpen,
    label: "Scanning bioRxiv / medRxiv",
    sublabel: "Preprint server cross-reference in progress...",
    duration: 900
  },
  {
    id: 5,
    icon: Database,
    label: "Cross-referencing Scopus",
    sublabel: "Checking 90M+ indexed records...",
    duration: 800
  },
  {
    id: 6,
    icon: Shield,
    label: "Analyzing protocol novelty",
    sublabel: "Comparing experimental designs, endpoints, conditions...",
    duration: 1200
  },
  {
    id: 7,
    ...
    sublabel: "Aggregating signal across all matched references...",
    duration: 700
  }
];
    ...
    if (isLQCReady && activeStep === SCAN_STEPS.length - 1) {
      const timer = setTimeout(() => {
        setCompletedSteps((prev) => {
          const lastStepId = SCAN_STEPS[activeStep].id;
          if (prev.includes(lastStepId)) return prev;
          return [...prev, lastStepId];
        });
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {(isActive || isCompleted) && (
                        <p
                          className={`mt-0.5 ${isCompleted ? "text-slate-600" : "text-slate-500"}`}
                          style={{ fontSize: "11px", fontFamily: "JetBrains Mono, monospace" }}
                        >
                          {step.sublabel}
                        </p>
